...
<html>
<head>
<title>Registro de Notas | Sistema de Notas primaria</title>
    ...
    <tr>
        ...
        <?php
           if(existeNota($alumno['id'],$id_materia,$conn) > 0){
            ...
            echo '<td align="center">'.notaLetra($alumno['promedio']).'</td>'; // Agrega esta línea
            if(existeNota($alumno['id'],$id_materia,$conn) > 0){
